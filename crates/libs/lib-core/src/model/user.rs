use super::base::{self, prep_fields_for_update};
use super::{base::DbBmc, ModelManager};
use crate::model::{Error, Result};
use crate::{ctx::Ctx, model::modql_utils::time_to_sea_value};
...
pub struct UserFilter {
    ...
    pub ctime: Option<OpValsValue>, // creation time
    pub mid: Option<OpValsInt64>,
    #[modql(to_sea_value_fn = "time_to_sea_value")]
    pub mtime: Option<OpValsValue>, // modification time
}
